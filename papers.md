...
* Anca Dumitrache, Lora Aroyo and Chris Welty: **[Crowdsourcing Ground Truth for Medical Relation Extraction](https://arxiv.org/abs/1701.02185)**. [ACM TiiS Special Issue on Human-Centered Machine Learning](https://dl.acm.org/citation.cfm?id=3232718) Vol. 8, Issue 2, 2018. [```dataset```](https://github.com/CrowdTruth/Medical-Relation-Extraction)
